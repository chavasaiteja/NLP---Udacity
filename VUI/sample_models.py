...
def custom_model(input_dim, units, output_dim=29):
    ...
    simp_rnn = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn_1')
    bidir_rnn_1 = Bidirectional(simp_rnn)(input_data)
    bn_bidir_rnn_1 = BatchNormalization(name='bn_bidir_rnn_1')(bidir_rnn_1)
    bidir_rnn_2 = Bidirectional(simp_rnn)(bn_bidir_rnn_1)
    bn_bidir_rnn_2 = BatchNormalization(name='bn_bidir_rnn_1')(bn_bidir_rnn_1)
...
def final_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn_3 = Bidirectional(simp_rnn)(bn_bidir_rnn_2)
    bn_bidir_rnn_3 = BatchNormalization(name='bn_bidir_rnn_3')(bidir_rnn_3)
    time_dense = TimeDistributed(Dense(output_dim))(bn_bidir_rnn_3)
    # TODO: Add softmax activation layer
    y_pred = Activation('softmax', name='softmax')(time_dense)
    # Specify the model
    model = Model(inputs=input_data, outputs=y_pred)
